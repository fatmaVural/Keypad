...
unsigned char get_keypad() {
    ...
    PORTBbits.RB0=1;
    if(PORTBbits.RB3==1) _delay((unsigned long)((20)*(4000000/4000.0))),k=1;
    if(PORTBbits.RB4==1) _delay((unsigned long)((20)*(4000000/4000.0))),k=4;
    if(PORTBbits.RB5==1) _delay((unsigned long)((20)*(4000000/4000.0))),k=7;
    if(PORTBbits.RB6==1) _delay((unsigned long)((20)*(4000000/4000.0))),k=15;
    PORTBbits.RB0=0;

    PORTBbits.RB1=1;
    if(PORTBbits.RB3==1) _delay((unsigned long)((20)*(4000000/4000.0))),k=2;
    if(PORTBbits.RB4==1) _delay((unsigned long)((20)*(4000000/4000.0))),k=5;
    if(PORTBbits.RB5==1) _delay((unsigned long)((20)*(4000000/4000.0))),k=8;
    if(PORTBbits.RB6==1) _delay((unsigned long)((20)*(4000000/4000.0))),k=0x00;
    PORTBbits.RB1=0;

    PORTBbits.RB2=1;
    if(PORTBbits.RB3==1) _delay((unsigned long)((20)*(4000000/4000.0))),k=3;
    if(PORTBbits.RB4==1) _delay((unsigned long)((20)*(4000000/4000.0))),k=6;
    if(PORTBbits.RB5==1) _delay((unsigned long)((20)*(4000000/4000.0))),k=9;
    if(PORTBbits.RB6==1) _delay((unsigned long)((20)*(4000000/4000.0))),k=255;
    PORTBbits.RB2=0;
